...
tinymce.PluginManager.add("contaonewslink", function (editor) {
    ...
    editor.addButton('contaonewslink', {
        ...
        onclick: function () {
            ...
            html += '<h3>Newsarchiv auswählen</h3>';
            ...
            html += '<h3>Newsbeitrag auswählen</h3>';
            ...
            SM.addButton("auswählen", "btn primary", function () {
                ...
                if (id > 0) {
                    ...
                    if (selectedContent != '') {
                        tinymce.activeEditor.selection.setContent('{{news_open::' + id + '}}' + selectedContent + '{{link_close}} ');
                    } else {
                        var text = 'Hier klicken!';
                        editor.insertContent('{{news_open::' + id + '}}' + text + '{{link_close}} ');
                    }
                }
                this.hide();
            });
